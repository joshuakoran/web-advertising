...
Referencing prior W3C values and principles, GDPR, and a limited number of external documents, this document defines success criteria to evaluate the benefit and impact on the interests of societies, people, publishers, marketers, and browser vendors. No one factor is assumed to be more or less important than another.
...
key interests of the stakeholders who enable people's access to internet-connected information and services.

These principles are termed "principles" (rather than, for example, "guidelines" or
...
While vertical integration can simplify consumer transparency, it carries the danger of limiting consumer choices by bundling services. By contrast, the final sentence emphasizes decentralization, which is a third goal in support
...
-   Diversity of publishers that protects:
    ...
    -   Freedom of expression to represent minority voices
        ...
        -   Free elections protected against foreign manipulation
            ...
            -   While free speech requires allowing speech the majority does not approved of by the majority, we can label political speech can be labeled by with nationality of the author’s nationality  and whether it is endorsed by one or more candidates 

        -   Freedom of the press enables watch-dog reporting on important issues and combats fake news
    ...
    -   Freedom of information to provide fast, easy access to internet-enabled
        ...
        -   Freedom from having to self-censor for fear of content consumption being
...
-   Free-market economies rely on competition, and competition benefits from
    ...
    -   Competition benefits from:
        ...
        -   low barriers of entry for individuals to start new businesses and compete
...
-   Appropriate risk mitigation and remedies
    ...
    -   Increased transparency on data collection and processing purposes:
        ...
        -   Increased control over any stable ID with which content consumption activity is associated
...
-   The publisher ad-funded business model is supported by addressing marketers
    ...
    -   Reducing quantity and quality of publishers’ content, conflicts with the interests of an open society
...
-   Ad-funded business model to provide free access to all:
    ...
    -   Same as marketers' interests to attract new people to the publisher's own
        property
...
-   Same interests as are desired by society and individuals plus:
    ...
    -   The ability to facilitate publisher and marketer engagement with end users
